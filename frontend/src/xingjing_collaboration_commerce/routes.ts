...
const seeds: readonly RouteSeed[] = [
  ...
  { id: "TM-015", module: "M11", path: "/team/team-project-cost-detail", loadEndpoint: "/workspaces/{workspaceId}/costs?projectId={projectId}", exportEndpoint: "/workspaces/{workspaceId}/billing/export.csv?dataset=costs&projectId={projectId}", relatedEndpoints: ["/workspaces/{workspaceId}/billing/journals"], responseKind: "list", requiredContext: ["workspaceId", "projectId"], viewPermission: "billing.view", managePermission: "billing.manage", columns: costColumns },
