...
const actionsZh: Record<string, string> = {
  ...
  assignSeat: "分配席位", reclaimSeat: "回收席位", requestInvoice: "申请开票", requestReconciliation: "发起对账",
